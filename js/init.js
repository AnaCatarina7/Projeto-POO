window.initdata = function initdata() {
  ...
  //Edication levals 
  if (!localStorage.getItem('educationLevels')) {
    const educationLevels = [
      {
        id: 1,
        name: "Ensino Básico (2.º Ciclo)",
        subjects: []
      },
      {
        id: 2,
        name: "Ensino Básico (3.º Ciclo)",
        subjects: ['Português','Inglês','Francês','Espanhol','História','Geografia','Matemática','Ciências Naturais','Físico-Química']
      },
      {
        id: 3,
        name: "Ensino Secundário",
        subjects: ['Biologia e Geologia','Física e Química A','Geometria Descritiva A','Matemática A','Filosofia','Língua Estrangeira','Português']
      }
    ];
